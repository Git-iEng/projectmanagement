...
# CHANGE BY JYOTI - 11-Sep-2026: START - Email OTP backend for Project Management website
# ============================================================
# CONTACT EMAIL OTP
# ============================================================
...
def _send_contact_otp_email(
    ...
    subject = (
        "Project Management Email Verification Code"
    )
...
def request_demo_view(request):
    ...
    subject = "New Project Management Enquiry"

    text_body = (
        "A new Project Management enquiry request "
        "was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">
            New Project Management Enquiry Request
        </h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Project Management"
        text_body = "\n".join(
            [
                "New contact submission for Project Management:",
...
def contact_block_submit(request):
    """
    Handles the Project Management consulting/contact form.
    """
    ...
    # CHANGE BY JYOTI - 11-Sep-2026:
    # Project Management email notification.
    subject = (
        f"[Project Management Website] "
    ...
    text_body = "\n".join(
        [
            (
                ...
                "submitted for Project Management:"
            ),
            f"Name: {name}",
            f"Email: {email}",
            (
